...
php tests/run.php                   # тесты ядра (507 методов, 1053 утверждений)
php tools/verify-purity.php         # домен не зависит от фреймворка (83 файлов)
...
| Область | Состояние |
|---|---|
| Ядро (хуки, модули, ошибки, Money, QR, state machines, tenancy) + домены P2–P7 | ✅ 507 тестов, 1053 утверждений |
