...
php tests/run.php                   # тесты ядра (403 методов, 860 утверждений)
php tools/verify-purity.php         # домен не зависит от фреймворка (68 файлов)
...
| Область | Состояние |
|---|---|
| Ядро (хуки, модули, ошибки, Money, QR, state machines, tenancy) + домены P2–P6 | ✅ 403 тестов, 860 утверждений |
